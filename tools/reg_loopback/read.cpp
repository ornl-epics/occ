...
static void usage(const char *progname) {
    ...
    cout << endl;
    cout << "Using OCC hardware this tool reads Modular Device registers." << endl;
    cout << endl;
    cout << "Options:" << endl;
    cout << "  -d, --device-file FILE Required OCC board device filename" << endl;
    cout << "  -v, --verbose          Print packet comm data, must be at the end" << endl;
    cout << "  LOCATION               Read specified LOCATION." << endl;
    cout << "                         Limits: 0<LOCATION<127." << endl;
    cout << "                         Limits: 64<LOCATION<127. 0<VALUE<0xFFFFFFFF." << endl;
    cout << endl;
    cout << "Example:" << endl;
    cout << "./read -d /dev/occ4 64 -v" << endl;
}
