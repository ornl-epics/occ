...
static void usage(const char *progname) {
    ...
    cout << endl;
    cout << "Using OCC hardware this tool writes Modular Device registers." << endl;
    cout << endl;
    cout << "Options:" << endl;
    cout << "  -d, --device-file FILE  Required OCC board device filename" << endl;
    cout << "  -v                      Print packet comm data, must be at end of command" << endl;
    cout << "  LOCATION VALUE          Write VALUE to R/W reg at 64+LOCATION." << endl;
    cout << "                          Limits: 64<LOCATION<127. 0<VALUE<0xFFFFFFFF." << endl;
    cout << endl;
    cout << "Example:" << endl;
    cout << "./write -d /dev/occ4 64 0x12345678 -v" << endl;
}
...
void *receive_from_occ(void *arg) {
    ...
    // Print received data
    usleep(100); // Give the send request output time to finish
    if (ctx->verbose)
